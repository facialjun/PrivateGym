...
type RoomADetailScreenNavigationProps = StackNavigationProp<
    BookingStackParamList,
    BookingScreens.RoomADetail
>;

interface RoomADetailScreenProps {
    navigation: RoomADetailScreenNavigationProps;
};

////////////////////////////////////////////////////////////////////////

const RoomADetailScreen:React.FunctionComponent<RoomADetailScreenProps> = (props) => {
...
return (
  <>
    <ScrollView
    style={{backgroundColor:'white'}} showsVerticalScrollIndicator={false}
    refreshControl={
...
export default RoomADetailScreen
