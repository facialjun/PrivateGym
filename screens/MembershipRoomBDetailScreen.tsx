...
type MembershipRoomBDetailScreenNavigationProps = StackNavigationProp<
    MembershipStackParamList,
    MembershipScreens.MembershipRoomBDetail
>;

interface MembershipRoomBDetailScreenProps {
    navigation: MembershipRoomBDetailScreenNavigationProps;
};

////////////////////////////////////////////////////////////////////////

const MembershipRoomBDetailScreen:React.FunctionComponent<MembershipRoomBDetailScreenProps> = (props) => {
...
/>
                ...
                <View style={{flex:1,backgroundColor:'white',justifyContent:'center',borderBottomWidth:5,borderBottomColor:'#E5E5E5'}}>
                    <Text style={{ fontSize: 21,marginLeft:'6%',marginTop:'1%' }}>짐프라이빗 2번룸</Text>  
...
export default MembershipRoomBDetailScreen
