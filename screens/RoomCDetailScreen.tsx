...
import { View,ScrollView,Text,StyleSheet,TouchableOpacity, Dimensions, RefreshControl,Platform,FlatList,Image } from 'react-native'
...
type RoomCDetailScreenNavigationProps = StackNavigationProp<
    BookingStackParamList,
    BookingScreens.RoomCDetail
>;

interface RoomCDetailScreenProps {
    navigation: RoomCDetailScreenNavigationProps;
};
        ...
        <View style={{justifyContent:'center', alignItems:'center',height:'auto',backgroundColor:'white'}}>
            <View style={{width:screenWidth,height:screenWidth,backgroundColor:'red'}}>
                ...
                <View style={{flex:1,backgroundColor:'white',justifyContent:'center',borderBottomWidth:5,borderBottomColor:'#E5E5E5'}}>
                    <Text style={{ fontSize: 21,marginLeft:'6%',marginTop:'1%' }}>짐프라이빗 3번방</Text>  
...
export default RoomCDetailScreen
