...
import { Icon, IconButton, List, Text, Image } from 'native-base';
...
type paymentResultScreenNavigationProps = StackNavigationProp<
    MainStackParamList,
    MainScreens.PT
    >

interface paymentResultScreenProps {
    navigation: paymentResultScreenNavigationProps;
}
...
const PaymentResult:React.FunctionComponent<paymentResultScreenProps> = ({ route, navigation }) =>{
    ...
    >
      {isSuccess ? (
        <View style={{borderRadius:10,}}>
          ...
          source={require('../../src/images/Paid.png')}
          alt="Paid"
          />
        ...
        <View style={{borderRadius:10,}}>
          ...
          source={require('../../src/images/notPaid.png')}
          alt="Not Paid"
          />
